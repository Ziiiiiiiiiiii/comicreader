...
<section class="section">
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="title mb-30">
                        <h2>Edit SubContent for Article</h2>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="breadcrumb-wrapper mb-30">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="/edit_subcontent/{{ $subcontent->id }}">@yield('title')</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="card-style mb-30">
            <form action="{{ route('storesubcontent', $subcontent->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="select-position">
                        <select name="inputarticleid">
                            ...
                            <option value="{{ $article->id }}"
                                {{ ($subcontent->article_id == $article->id) ? 'selected' : '' }}>{{ $article->title }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="input-style-1 col-lg-12" for="title">
                    <input class="col-sm-8" type="text" id="title" name="inputtitle" value="{{ $subcontent->title }}" />
                </div>
                @else
                <div class="input-style-1 col-lg-12" for="title">
                ...
                <div class="input-style-1 col-lg-12" for="content">
                    <div class="input-style-3">
                        <textarea id="content" name="inputcontent" placeholder="Content"
                            rows="7">{{ $subcontent->content }}</textarea>
